...
![부정/긍정 비율 시각화](최종 공포지수및 데이터 비교_6.png)


## 시계열(date) 기준 부정 비율 변화 확인

![시계열(date) 기준 부정 비율 변화 확인](최종 공포지수및 데이터 비교_11.png)
...
![이분류 결과](최종 공포지수및 데이터 비교_5.png)  
![이분류 결과](최종 공포지수및 데이터 비교_6.png)
...
![공포-탐욕지수와 부정 감성 비율 비교](최종 공포지수및 데이터 비교_3.png)  
![공포-탐욕지수와 부정 감성 비율 비교 정규화](최종 공포지수및 데이터 비교_4.png)
